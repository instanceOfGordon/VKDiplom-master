...
void
splineknots::ReducedDeBoorKnotsGenerator::InParallel(bool value)
{
	is_parallel_ = value;
...
splineknots::ReducedDeBoorKnotsGenerator::Tridagonals()
{
	return tridagonals_;
}

splineknots::ReducedTridiagonal&
splineknots::ReducedDeBoorKnotsGenerator::Tridiagonal()
{
