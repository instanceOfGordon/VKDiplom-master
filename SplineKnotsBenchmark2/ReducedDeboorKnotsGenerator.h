...
{
	typedef std::vector<std::unique_ptr<ReducedDeboorTridiagonal>> ReducedTridiagonals;
	...
	protected:
		...
		struct PrecalculatedReduced final : public DeBoorKnotsGenerator::Precalculated
		{
			double six_div_h,
				twelve_div_h,
				eighteen_div_h,
