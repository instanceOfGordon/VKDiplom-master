...
namespace splineknots {
	...
	template <typename TKnotGenerator>
	void CurveKnotsGenerator<TKnotGenerator>::InitializeKnots(SurfaceDimension& dimension, KnotMatrix& values)
	{
	...
	template <typename TKnotGenerator>
	std::unique_ptr<KnotMatrix> CurveKnotsGenerator<TKnotGenerator>::GenerateKnots(SurfaceDimension& dimension)
	{
	...
	template <typename TKnotGenerator>
	CurveKnotsGenerator<TKnotGenerator>::CurveKnotsGenerator(MathFunction math_function): knot_generator_(std::unique_ptr<TKnotGenerator>(new TKnotGenerator(math_function)))
	{
	}

	template <typename TKnotGenerator>
	CurveKnotsGenerator<TKnotGenerator>::~CurveKnotsGenerator()
	{
