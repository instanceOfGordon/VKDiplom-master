...
Tridiagonal::Tridiagonal(double lower_value, double main_value, double upper_value)
	:lower_diagonal_(kInitCount,lower_value),
	main_diagonal_(kInitCount,main_value),
	upper_diagonal_(kInitCount,upper_value),
...
void Tridiagonal::Resize(size_t newsize)
{
...
void Tridiagonal::Solve(size_t num_unknowns, double* right_side)
{
...
ReducedDeBoorTridiagonal::ReducedDeBoorTridiagonal()
	: Tridiagonal(1,-14, 1)
{
}
...
void ReducedDeBoorTridiagonal::Solve(size_t num_unknowns, double* right_side)
{
