...
splineknots::ReducedDeBoorKnotsGenerator::ReducedDeBoorKnotsGenerator(const ReducedDeBoorKnotsGenerator& other): DeBoorKnotsGenerator(other)
{
}

splineknots::ReducedDeBoorKnotsGenerator::ReducedDeBoorKnotsGenerator(ReducedDeBoorKnotsGenerator&& other): DeBoorKnotsGenerator(std::move(other))
{
}
...
void splineknots::ReducedDeBoorKnotsGenerator::RightSide(const RightSideSelector& right_side_variables, const DeBoorKnotsGenerator::Precalculated& precalculated,
...
void splineknots::ReducedDeBoorKnotsGenerator::SolveTridiagonal(const RightSideSelector& selector, const DeBoorKnotsGenerator::Precalculated& precalculated, const double dfirst, const double dlast, const int unknowns_count, UnknownsSetter& unknowns_setter)
{
	auto& tridiagonal = Tridiagonal(omp_get_thread_num());
