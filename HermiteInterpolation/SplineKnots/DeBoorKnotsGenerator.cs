...
namespace HermiteInterpolation.SplineKnots
{
    public class DeBoorKnotsGenerator : KnotsGenerator
    {
        ...
        protected void FillXDerivations(KnotMatrix values)
        {
        ...
        protected void FillDxyDerivations(KnotMatrix values)
        {
            FillDxyDerivations(0, values);
            FillDxyDerivations(values.Columns - 1, values);
        }

        protected void FillYDerivations(KnotMatrix values)
        {
        ...
        protected void FillDyxDerivations(KnotMatrix values)
        {
            for (var i = 0; i < values.Rows; i++)
            {
        ...
        protected virtual void FillXDerivations(int rowOrColumnIdx, KnotMatrix values)
        {
        ...
        protected virtual void FillYDerivations(int rowOrColumnIdx, KnotMatrix values)
        {
        ...
        protected virtual void FillDxyDerivations(int rowOrColumnIdx, KnotMatrix values)
        {
            var equationsCount = values.Rows - 2;
            if (equationsCount == 0) return;
        ...
        protected virtual void FillDyxDerivations(int rowOrColumnIdx, KnotMatrix values)
        {
            var equationsCount = values.Columns - 2;
            if (equationsCount == 0) return;
