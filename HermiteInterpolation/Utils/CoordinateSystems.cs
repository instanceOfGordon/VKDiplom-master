...
namespace HermiteInterpolation.Utils
{
    public static class CoordinateSystems
    {
        ...
        {
            return FromSphericalToCartesian(coordinates.X, coordinates.Y,
                coordinates.Z);
        }
        ...
        {
            return FromCartesianToSpherical(coordinates.X, coordinates.Y,
                coordinates.Z);
        }

        public static Vector3 FromSphericalToCartesian(float radius,
